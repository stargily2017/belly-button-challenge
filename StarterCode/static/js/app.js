...
function init() {
  ...
  //use D3 to retrieve all of the data
    ...
    let textSample = samplenames.filter(x => x.id == 940);
...
function update_dashboard(sample_value) { 
  ...
  barChart(sample_value);
  bubbleChart(sample_value);
  sample_metaData(sample_value);
  };
